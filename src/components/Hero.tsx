    ...
    >
      <div className="animate-fadeUp">
          ...
          {certifications.map((cert) => {
            ...
            return (
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border bg-bg-alt px-3 py-1.5 font-mono text-xs text-text-secondary transition-colors hover:border-accent hover:text-accent"
              >
        ...
        <p className="mt-4 max-w-2xl text-xl font-medium leading-snug text-text-secondary sm:text-2xl">
          {personal.positioning.map((line, i) => (
